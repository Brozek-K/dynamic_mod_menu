...
last_id_var = "dynamic_mod_menu_events_last_id"
first_id_var = "dynamic_mod_menu_events_first_id"
event_2_3_template = """
        {if_statement} = {{
            limit = {{
...
event_100_template = "        remove_global_flag = dmm_mod_events_{count}"
event_101_110_template = "        set_global_flag = dmm_mod_events_{count}"
...
def process(publish_dir):
    templater.process_file(
        publish_dir + "/events/dynamic_mod_menu_events.txt",
