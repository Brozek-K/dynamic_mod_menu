...
event_1_sub_template_mod = """
                {if_statement} = {{
                    limit = {{
                        has_global_flag = dmm_mod_events_{secondary_count}
                        check_variable = {{
                            which = dynamic_mod_menu_events_processed_id
                            value < {secondary_count}
                        }}
                    }}
                    set_global_flag = dmm_mod_events_{count}_{secondary_count}_active
                    change_variable = {{
                        which = dynamic_mod_menu_events_items_shown
                        value = 1
                    }}
...
event_3_template = """
        remove_global_flag = dmm_mod_events_{count}_{secondary_count}_active"""
event_4_template = """
...
event_8_template = """
        {if_statement} = {{
            limit = {{
                check_variable = {{
                    which = dynamic_mod_menu_events_last_id
                    value = {count}
                }}
                check_variable = {{
                    which = dynamic_mod_menu_events_processed_id
            ...
            set_global_flag = dynamic_mod_menu_events_no_new_pages
        }}"""
event_9_template = """
        {if_statement} = {{
            limit = {{
            ...
            set_global_flag = dynamic_mod_menu_events_no_prev_pages
        }}"""
...
def process(publish_dir):
    templater.process_file(
        publish_dir + "/events/dynamic_mod_menu_pagination_events.txt",
